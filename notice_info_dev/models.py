...
from notice_info.textChoices import CountryCode, YesOrNo
from notice_info.validation import validation_str_date_format
from .devAppKeyChoices import AppKey
...
class NoticeInfo(models.Model):
    app_key = models.CharField(max_length=8, choices=AppKey.choices, default=AppKey.AOS_DEV, help_text='팝업을 노출 할 앱')
